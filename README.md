...
1. **Primary — Docker Postgres + pgvector**  
   Run via `docker compose` (see Step 02 in [`planning-docs/steps/02-local-postgres-pgvector.md`](planning-docs/steps/02-local-postgres-pgvector.md)). Point **`DATABASE_URL`** in `.env` at this instance for everyday coding, tests, and offline work.  
